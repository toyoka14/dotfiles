...
const s:dpp_ext_protocol_git = '~/.cache/dpp/repos/github.com/Shougo/dpp-protocol-git'
...
" Set dpp ext runtime path (optional)
execute 'set runtimepath^=' .. s:dpp_ext_installer
execute 'set runtimepath^=' .. s:dpp_ext_protocol_git
